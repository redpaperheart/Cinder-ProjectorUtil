...
void ofxHomographyHelper::findHomography(Vec2f src[4], Vec2f dst[4], float homography[16]){
...
Matrix44d ofxHomographyHelper::findHomography(float src[4][2], float dst[4][2]){
	Matrix44d matrix;
	// create the equation system to be solved
	//
	// from: Multiple View Geometry in Computer Vision 2ed
